package com.bluehyperx.moodgleam.ui.settings
...
import com.bluehyperx.moodgleam.common.util.DebugInfoHelper
import com.bluehyperx.moodgleam.common.util.DevOptionsHelper
...
fun SettingsScreen(
    ...
    var showWizScanDialog by remember { mutableStateOf(false) }

    var useWizBg by remember {
        mutableStateOf(prefs.getBoolean(R.string.pref_key_music_use_wiz_background, false))
    }
    var wizBgIp by remember(showWizScanDialog) {
        mutableStateOf(prefs.getString(R.string.pref_key_wiz_background_ip, "") ?: "")
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsGroup(title = stringResource(R.string.pref_group_connection)) {
                ...
                val isNetwork = connectionType == "hyperion" || connectionType == "wled" || connectionType == "wiz"
                val isAdalight = connectionType == "adalight" || connectionType == "bluetooth"
                ...
                if (isAdalight) {
                    if (connectionType == "bluetooth") {
                        val bluetoothDefaultSummary = stringResource(R.string.pref_summary_bluetooth_device)
                        EditTextPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_bluetooth_device,
                            title = stringResource(R.string.pref_title_bluetooth_device),
                            summaryProvider = { 
                                if (it.isEmpty()) bluetoothDefaultSummary else it 
                            },
                ...
                if (connectionType == "wiz") {
                    CheckBoxPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_wiz_scenes_enabled,
                        title = stringResource(R.string.pref_title_wiz_scenes_enabled),
                        summary = stringResource(R.string.pref_summary_wiz_scenes_enabled),
                        onValueChange = { enabled ->
                        }
                    )
                }
            ...
            SettingsGroup(title = stringResource(R.string.pref_group_capturing)) {
                // Capture Source (Screen / Camera / Effects)
                key(captureSource) {
                    ListPreference(
                        prefs = prefs,
                ...
                if (captureSource == "music") {
                    ListPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_capture_method,
                        title = stringResource(R.string.pref_title_music_capture_method),
                        entriesRes = R.array.pref_list_music_capture_method,
                        entryValuesRes = R.array.pref_list_music_capture_method_values,
                        onValueChange = { newMethod ->
                        }
                    )
                    ListPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_sampling_rate,
                        title = stringResource(R.string.pref_title_music_sampling_rate),
                        entriesRes = R.array.pref_list_music_sampling_rate,
                        entryValuesRes = R.array.pref_list_music_sampling_rate_values,
                        onValueChange = { newRate ->
                        }
                    )
                    ListPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_sample_step,
                        title = stringResource(R.string.pref_title_music_sample_step),
                        entriesRes = R.array.pref_list_music_sample_step,
                        entryValuesRes = R.array.pref_list_music_sample_step_values,
                    ...
                    CheckBoxPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_use_wiz_background,
                        title = stringResource(R.string.pref_title_music_use_wiz_background),
                        summary = stringResource(R.string.pref_summary_music_use_wiz_background),
                        onValueChange = { enabled ->
                            useWizBg = enabled
                        }
                    )
                    ...
                    if (useWizBg) {
                        EditTextPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_wiz_background_ip,
                            title = stringResource(R.string.pref_title_wiz_background_ip),
                            summaryProvider = { if (it.isEmpty()) "Not set. Tap to enter or scan" else it },
                            recomposeKey = wizBgIp,
                            onValueChange = { newIp ->
                                wizBgIp = newIp
                            }
                        )
                        ...
                        ClickablePreference(
                            title = "Scan for WiZ Bulb",
                            summary = "Find a WiZ bulb on your local network automatically",
                            onClick = { showWizScanDialog = true }
                        )

                        ListPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_wiz_background_mode,
                            title = stringResource(R.string.pref_title_wiz_background_mode),
                            entriesRes = R.array.pref_list_wiz_background_mode,
                            entryValuesRes = R.array.pref_list_wiz_background_mode_values,
                        ...
                        EditTextPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_wiz_brightness,
                            title = stringResource(R.string.pref_title_wiz_brightness),
                            summaryProvider = { "$it%" },
                            keyboardType = KeyboardType.Number,
                            onValueChange = { newValue ->
                            }
                        ...
                        // Hardware Calibration for the WiZ bulb
                        Text(
                            text = "WiZ Calibration",
                        ...
                        EditTextPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_wiz_calib_r,
                            title = stringResource(R.string.pref_title_wiz_calib_r),
                            summaryProvider = { it },
                            keyboardType = KeyboardType.Number,
                            onValueChange = { newValue ->
                            }
                        ...
                        EditTextPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_wiz_calib_g,
                            title = stringResource(R.string.pref_title_wiz_calib_g),
                            summaryProvider = { it },
                            keyboardType = KeyboardType.Number,
                            onValueChange = { newValue ->
                            }
                        ...
                        EditTextPreference(
                            prefs = prefs,
                            keyRes = R.string.pref_key_wiz_calib_b,
                            title = stringResource(R.string.pref_title_wiz_calib_b),
                            summaryProvider = { it },
                            keyboardType = KeyboardType.Number,
                            onValueChange = { newValue ->
                            }
                    ...
                    EditTextPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_weight_bass,
                        title = stringResource(R.string.pref_title_music_weight_bass),
                        summaryProvider = { it },
                        keyboardType = KeyboardType.Number,
                        onValueChange = { newValue ->
                        }
                    ...
                    EditTextPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_weight_mid,
                        title = stringResource(R.string.pref_title_music_weight_mid),
                        summaryProvider = { it },
                        keyboardType = KeyboardType.Number,
                        onValueChange = { newValue ->
                        }
                    ...
                    EditTextPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_weight_high,
                        title = stringResource(R.string.pref_title_music_weight_high),
                        summaryProvider = { it },
                        keyboardType = KeyboardType.Number,
                        onValueChange = { newValue ->
                        }
                    ...
                    EditTextPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_threshold_bass_mid,
                        title = stringResource(R.string.pref_title_music_threshold_bass_mid),
                        summaryProvider = { it },
                        keyboardType = KeyboardType.Number,
                        onValueChange = { newValue ->
                        }
                    ...
                    EditTextPreference(
                        prefs = prefs,
                        keyRes = R.string.pref_key_music_threshold_mid_high,
                        title = stringResource(R.string.pref_title_music_threshold_mid_high),
                        summaryProvider = { it },
                        keyboardType = KeyboardType.Number,
                        onValueChange = { newValue ->
                        }
    ...
    if (showScanDialog) {
        DeviceScanDialog(
            ...
            onDeviceSelected = { device ->
                when (device.type) {
                    com.bluehyperx.moodgleam.common.network.DeviceDetector.DeviceType.WLED -> {
                    ...
                    com.bluehyperx.moodgleam.common.network.DeviceDetector.DeviceType.HYPERION -> {
                        val newConnectionType = "hyperion"
                        prefs.putString(R.string.pref_key_connection_type, newConnectionType)
                        connectionType = newConnectionType
                    }

                    com.bluehyperx.moodgleam.common.network.DeviceDetector.DeviceType.WIZ -> {
                        val newConnectionType = "wiz"
                        prefs.putString(R.string.pref_key_connection_type, newConnectionType)
                        connectionType = newConnectionType
                    }
    ...
    if (showWizScanDialog) {
        DeviceScanDialog(
            onDismiss = { showWizScanDialog = false },
            targetDeviceType = com.bluehyperx.moodgleam.common.network.DeviceDetector.DeviceType.WIZ,
            onDeviceSelected = { device ->
                if (device.type == com.bluehyperx.moodgleam.common.network.DeviceDetector.DeviceType.WIZ) {
                    prefs.putString(R.string.pref_key_wiz_background_ip, device.host)
                    Toast.makeText(context, "WiZ Background IP set to ${device.host}", Toast.LENGTH_SHORT).show()
                    showWizScanDialog = false
                } else {
                    Toast.makeText(context, "Please select a WiZ device", Toast.LENGTH_SHORT).show()
                }
            }
        )
    }
